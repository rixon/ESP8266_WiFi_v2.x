...
#define EEPROM_EMON_NODE_SIZE         20
#define EEPROM_MQTT_SERVER_SIZE       45
#define EEPROM_MQTT_TOPIC_SIZE        20
#define EEPROM_MQTT_USER_SIZE         20
#define EEPROM_MQTT_PASS_SIZE         64
#define EEPROM_MQTT_SOLAR_SIZE        32
#define EEPROM_MQTT_SOLARTYPE_SIZE    1
#define EEPROM_MQTT_USE_SIZE          32
...
#define EEPROM_MQTT_SOLARTYPE_START    EEPROM_MQTT_SOLAR_END
#define EEPROM_MQTT_SOLARTYPE_END      (EEPROM_MQTT_SOLARTYPE_START + EEPROM_MQTT_SOLARTYPE_SIZE)
#define EEPROM_MQTT_USE_START          EEPROM_MQTT_SOLARTYPE_END

#define EEPROM_MQTT_USE_END            {EEPROM_MQTT_USE_START + EEPROM_MQTT_USE_SIZE)
...
void config_save_mqtt(String server, String topic, String user, String pass, String solar, String use, String solartype)
{
  mqtt_server = server;
  mqtt_topic = topic;
  mqtt_user = user;
  ...
  EEPROM_write_string(EEPROM_MQTT_USE_START, EEPROM_MQTT_USE_SIZE, mqtt_use);
  EEPROM_write_string(EEPROM_MQTT_SOLARTYPE_START, EEPROM_MQTT_SOLARTYPE_SIZE, mqtt_solartype);
